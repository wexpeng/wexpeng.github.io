    ...
    , function(e, t, n) {
        ...
        r.prototype.init = function(e) {
            ...
            try {
                ...
                t.notify = e.notify || !1,
                t.verify = e.verify || !1,
                v.params = "?d=" + (i.indexOf(o) > -1 ? o : "mp"),
                v.hide = "hide" === o,
                v.cdn = !!s && s || v.cdn,
                b = e.path || b;
                var l = Number(e.pageSize || 10);
                if (e.pageSize = isNaN(l) ? 10 : l < 1 ? 10 : l,
                a.setOptions({
                ...
                for (var x = d.findAll(document, ".valine-comment-count"), w = 0, k = x.length; w < k; w++)
                    !function(e, n) {
                        var r = x[e];
                        if (r) {
                ...
                if (!(_ = _ instanceof HTMLElement ? _ : A[A.length - 1] || null))
                    return;
                t.el = _,
                ...
                t.loading = {
                    show: function(e) {
                        ...
                        return e ? E.insertBefore($, n[0]) : E.appendChild($),
                        t.nodata.hide(),
                        t
                    },
                    hide: function() {
                        var e = d.find(E, ".vloading");
                        return e && d.remove(E, e),
                        0 === d.findAll(E, ".vcard").length && t.nodata.show(),
                        t
                    }
                };
                ...
                t.alert = {
                    show: function(e) {
                        ...
                        d.on("click", d.find(C, ".vcancel"), function(e) {
                            t.alert.hide()
                        }),
                        d.attr(C, "style", "display:block;"),
                        e && e.type) {
                    ...
                    hide: function() {
                        return d.attr(C, "style", "display:none;"),
                        t
                    }
                },
                t.bind(e)
        ...
        r.prototype.bind = function(e) {
            ...
            var x = function(e) {
                ...
                return d.each(n, function(e, n) {
                    1 === n.nodeType && (r.indexOf(n.nodeName) > -1 && ("INPUT" === n.nodeName && "checkbox" === d.attr(n, "type") ? d.attr(n, "disabled", "disabled") : d.remove(t, n)),
                    "A" === n.nodeName && i(n, "href"),
                    ["IFRAME", "FRAME"].indexOf(n.nodeName) > -1 && i(n, "src"),
                    d.clearAttr(n))
                }),
                t.innerHTML
            }
            ...
            var j = function() {
              ...
              , P = d.find(t.el, ".vsubmit")
              , U = function(e) {
                if (d.attr(P, "disabled"))
              ...
              , Q = function() {
                ...
                R.rid && (n.set("rid", R.rid),
                f.comment = R.at + f.comment);
                for (var r in f)
